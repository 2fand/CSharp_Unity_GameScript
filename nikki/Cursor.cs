            ...
            if (1 < you.yourSelects.GetLength(0) && 0 != indexI && null != you.yourSelects[indexI - 1, indexJ])
            {
                ...
                switch (verticalMoveMode)
                {
                    ...
                    case VerticalMoveMode.toNextColumn:
                        if (indexJ > columnLoopField[0] && verticalLoopField[indexJ, 0] == indexI && -1 != verticalLoopField[indexJ - 1, 0])
                        {
                            isCanDo = true;
                            indexI = verticalLoopField[--indexJ, 1];
                        }
                    ...
                    case VerticalMoveMode.toNextColumnAndLoop:
                        ...
                        else if(columnLoopField[0] == indexJ && verticalLoopField[columnLoopField[0], 0] == indexI)
                        {
                            isCanDo = true;
            ...
            else
            {
                switch (verticalMoveMode)
                {
                    case VerticalMoveMode.loop:
                        ...
                        break;
                    case VerticalMoveMode.toNextColumn:
                        if (indexJ < columnLoopField[1] && verticalLoopField[indexJ, 1] == indexI && -1 != verticalLoopField[indexJ + 1, 0])
                        {
                            isCanDo = true;
                            indexI = verticalLoopField[++indexJ, 0];
                        }
                    ...
                    case VerticalMoveMode.toNextColumnAndLoop:
                        ...
                        else if (you.yourSelects.GetLength(1) - 1 == indexJ && verticalLoopField[columnLoopField[1], 1] == indexI)
                        {
                            isCanDo = true;
            ...
            else
            {
                switch (horizontalMoveMode)
                {
                    ...
                    case HorizontalMoveMode.toNextRow:
                        if (indexI > rowLoopField[0] && horizontalLoopField[indexI, 0] == indexJ && -1 != horizontalLoopField[indexI - 1, 0])
                        {
                            isCanDo = true;
                    ...
                    case HorizontalMoveMode.toNextRowAndLoop:
                        ...
                        else if (rowLoopField[0] == indexI && horizontalLoopField[rowLoopField[0], 0] == indexJ)
                        {
                            isCanDo = true;
            ...
            else
            {
                switch (horizontalMoveMode)
                {
                    case HorizontalMoveMode.loop:
                        ...
                        break;
                    case HorizontalMoveMode.toNextRow:
                        if (indexI < rowLoopField[1] && horizontalLoopField[indexI, 1] == indexJ && -1 != horizontalLoopField[indexI + 1, 0])
                        {
                            isCanDo = true;
                    ...
                    case HorizontalMoveMode.toNextRowAndLoop:
                        ...
                        else if (rowLoopField[1] == indexI && horizontalLoopField[rowLoopField[1], 1] == indexJ)
                        {
                            isCanDo = true;
