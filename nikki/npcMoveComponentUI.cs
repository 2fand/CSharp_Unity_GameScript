...
public class npcMoveComponentUI : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        npcMove.canTurn = EditorGUILayout.Toggle("npc移动后是否改变方向", npcMove.canTurn);
        ...
        if (npcMove.move.Catch == npcMove.moveMode) {
            ...
            npcMove.teleWorldName = EditorGUILayout.TextField("被抓后传送到的世界名");
            ...
            npcMove.teleYouFront = (npcMove.wasd)EditorGUILayout.EnumPopup("被抓后我的方向", npcMove.teleYouFront); 
        }
    }
}
