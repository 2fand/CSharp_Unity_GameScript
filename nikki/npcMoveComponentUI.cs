...
public class npcMoveComponentUI : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (npcMove.move.Catch == npcMove.moveMode) {
            ...
            npcMove.enterMode = (change.transitionMode)EditorGUILayout.EnumPopup("被抓前转场", npcMove.enterMode);
            npcMove.enterTime = EditorGUILayout.FloatField("被抓前转场时间", npcMove.enterTime);
            npcMove.exitMode = (change.transitionMode)EditorGUILayout.EnumPopup("被抓后转场", npcMove.exitMode);
