...
public class createMenuTheme : MonoBehaviour
{
    ...
    void Start()
    {
        menuTheme = new MenuTheme(mode, menu, menuLeft, menuRight, menuUp, menuDown, menuLeftUp, menuRightUp, menuLeftDown, menuRightDown, menuCenter, menu_1x1, menu_1x_c, menu_1x_u, menu_1x_d, menu_x1_c, menu_x1_l, menu_x1_r, cursor, myCloseUpFrame, cursorDodgeMode, cursorAnimation, menuTextColor, menuHighlightColor, menuUnselectColor);
        if (null == menuTheme)
        {
            ID = -1;
