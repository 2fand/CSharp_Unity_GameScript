...
public class z : MonoBehaviour
{
    ...
    void Update()
    {
        if (((m.horizontalIsCycle ? (you.x + 1) % m.x : you.x + 1) == GetComponent<wall>().x && you.y == GetComponent<wall>().y && you.front == you.wasd.d && (!haveFront || you.wasd.a == GetComponent<wall>().front) && Input.GetKeyDown("z")) || ((you.x - 1 < 0 && m.horizontalIsCycle ? m.x - 1 : you.x - 1) == GetComponent<wall>().x && you.y == GetComponent<wall>().y && you.front == you.wasd.a && (!haveFront || you.wasd.d == GetComponent<wall>().front) && Input.GetKeyDown("z")) || (you.x == GetComponent<wall>().x && (m.verticalIsCycle ? (you.y + 1) % m.y : you.y + 1) == GetComponent<wall>().y && you.front == you.wasd.s && (!haveFront || you.wasd.w == GetComponent<wall>().front) && Input.GetKeyDown("z")) || (you.x == GetComponent<wall>().x && (you.y - 1 < 0 && m.verticalIsCycle ? m.y - 1 : you.y - 1) == GetComponent<wall>().y && you.front == you.wasd.w && (!haveFront || you.wasd.s == GetComponent<wall>().front) && Input.GetKeyDown("z")))
        {
            if (mode.tele == mod)
            {
                StartCoroutine(go());
