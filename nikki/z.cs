...
public class z : MonoBehaviour
{
    ...
    public int teleX = 0;
    public int teleY = 0;
    public change.changeMode changeMode = change.changeMode.showAndHide;
    ...
    private IEnumerator go()
    {
        ...
        switch (changeMode)
        {
            case change.changeMode.showAndHide:
                for (int i = 0; i < 50; i++)
                {
        ...
        you.mode = changeMode;
        StartCoroutine(you.tele(worldName, teleX, teleY, w.front, closeSound));
    }
