...
public class edit : MonoBehaviour
{
    ...
    public int wallExtendLeft = 0;
    public int wallExtendRight = 0;
    public int wallExtendUp = 0;
    public int wallExtendDown = 0;
    ...
    private void editTile(int x, int y, ref Vector3[] clones)
    {
        ...
        if (isMakeWall)
        {
            ...
            wall.GetComponent<wall>().extendLeft = wallExtendLeft;
            wall.GetComponent<wall>().extendRight = wallExtendRight;
            wall.GetComponent<wall>().extendUp = wallExtendUp;
            wall.GetComponent<wall>().extendDown = wallExtendDown;
                    ...
                    for (int j = 0; j < m.y; j++)
                    {
                        ...
                        else
                        {
                            ...
                            if (isMakeWall)
                            {
                                ...
                                editMap[i, j].GetComponent<wall>().extendLeft = wallExtendLeft;
                                editMap[i, j].GetComponent<wall>().extendRight = wallExtendRight;
                                editMap[i, j].GetComponent<wall>().extendUp = wallExtendUp;
                                editMap[i, j].GetComponent<wall>().extendDown = wallExtendDown;
